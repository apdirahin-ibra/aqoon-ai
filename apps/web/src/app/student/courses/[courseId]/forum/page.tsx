            ...
            <CardContent className="pt-6">
              <div className="flex gap-6">
                <div className="flex flex-col items-center gap-2 pt-1">
                  ...
                  <button className="rounded-lg p-1 transition-colors hover:bg-muted rotate-180">
                ...
                <div className="flex-1">
                  ...
                  <div className="prose prose-sm dark:prose-invert max-w-none mb-8 text-muted-foreground italic">
                ...
                <div className="mt-8 pt-6 border-t">
                  ...
                  <div className="flex gap-4">
                    ...
                    <Button
                      ...
                      className="h-auto px-6 rounded-2xl"
                    >
