      ...
      {certificates.length > 0 ? (
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {certificates.map((cert, i) => (
            <Card
              key={cert.id}
              className="group overflow-hidden rounded-2xl shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-xl animate-in fade-in slide-in-from-bottom-4"
              style={{
            ...
            >
              ...
              <div className="relative flex h-36 items-center justify-center bg-linear-to-br from-primary/15 via-primary/5 to-accent/10">
                <div className="text-center">
                  ...
                  <p className="font-display font-semibold text-xs text-primary/80">
