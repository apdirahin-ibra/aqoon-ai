      ...
      <div className="container py-8">
        ...
        <div className="mx-auto grid max-w-2xl gap-4 sm:grid-cols-3">
          {categories.map((cat, i) => (
            <Card
              key={cat.id}
              className="cursor-pointer rounded-2xl shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-primary hover:shadow-xl animate-in fade-in slide-in-from-bottom-4"
              style={{
