import { BookOpen, Globe, MapPin, Star, Users } from "lucide-react";
			...
			<section className="bg-linear-to-b from-primary/5 to-background py-16">
				<div className="container">
					<div className="flex flex-col items-center gap-6 sm:flex-row sm:items-start">
						<div className="flex h-24 w-24 shrink-0 items-center justify-center rounded-full bg-linear-to-br from-primary/30 to-primary/10 font-bold text-4xl text-primary">
							{tutor.name.charAt(0)}
						</div>
						<div className="text-center sm:text-left">
							...
							<div className="flex flex-wrap items-center justify-center gap-3 text-muted-foreground text-sm sm:justify-start">
