...
> = {
  ...
  payment: {
    icon: DollarSign,
    gradient: "bg-linear-to-br from-amber-500/20 to-amber-500/5",
    color: "text-amber-600",
  },
  security: {
    icon: Shield,
    gradient: "bg-linear-to-br from-red-500/20 to-red-500/5",
    color: "text-red-600",
  },
  message: {
    icon: MessageSquare,
        ...
        <Card className="rounded-2xl">
          <CardContent className="py-12 text-center">
            ...
            <p className="mt-1 text-muted-foreground text-xs">
              System alerts and platform updates will appear here
            </p>
          </CardContent>
        </Card>
      )}
