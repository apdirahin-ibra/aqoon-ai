              ...
              filtered.map((conv) => (
                ...
                >
                  <Avatar className="h-8 w-8 shrink-0">
                    ...
                    <AvatarFallback className="bg-linear-to-br from-red-500/20 to-red-500/5 text-xs">
                  ...
                  {conv.unreadCount > 0 && (
                    <span className="flex h-4 w-4 shrink-0 items-center justify-center rounded-full bg-destructive font-bold text-[10px] text-destructive-foreground">
                      {conv.unreadCount}
                    </span>
                  )}
                </button>
            ...
            <>
              ...
              <div className="flex items-center gap-3 border-b px-4 py-3">
                <Avatar className="h-9 w-9">
                  ...
                  <AvatarFallback className="bg-linear-to-br from-red-500/20 to-red-500/5 text-sm">
