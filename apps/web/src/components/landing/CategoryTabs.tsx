        ...
        <div key={category.id} className="animate-fade-in">
          <div className="grid items-center gap-8 lg:grid-cols-2">
            ...
            <div className="order-2 lg:order-1">
              <div
                className={cn(
                  "inline-flex items-center gap-2 mb-4 rounded-full px-4 py-2 font-medium text-sm",
                  category.bgColor,
                  category.color,
                )}
              >
              ...
              <div className="relative">
                ...
                <div className="relative rounded-3xl border border-border bg-gradient-to-br from-card to-muted p-8">
                  <div className="mb-6 flex items-center gap-4">
                    <div
                      className={cn(
                        "h-16 w-16 flex items-center justify-center rounded-2xl shadow-sm",
                        category.bgColor,
                      )}
                    >
                      <category.icon
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    {[
                      ...
                      <div
                        key={item.label}
                        className="rounded-xl bg-background/50 p-4 text-center border border-border/10 shadow-sm"
                      >
                        <div className="font-bold text-foreground text-xl leading-none mb-1">
                          {item.label}
                        </div>
